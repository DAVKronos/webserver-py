...
const UsersRouter = () => {
  return (
    <Switch>
      <PrivateRoute action='view' subject='User' exact path='/users' component={Users} />
      ...
      <PrivateRoute action='edit' subject='User' path='/users/:id/edit' component={EditUser} />
      <PrivateRoute action='view' subject='User' path='/users/:id' component={User} />
    </Switch>
  )
}
